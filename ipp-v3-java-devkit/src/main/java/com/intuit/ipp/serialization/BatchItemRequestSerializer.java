...
public class BatchItemRequestSerializer extends JsonSerializer<BatchItemRequest> {
    ...
    private static final ObjectMapper cdcQueryMapper = getCDCQueryMapper();
     ...
     *
     * @param cdcQuery the CDCQuery entity describing need for query
    ...
    private String getCDCQueryJson(CDCQuery cdcQuery) throws SerializationException {
        String json = null;
        try {
            json = cdcQueryMapper.writeValueAsString(cdcQuery);
        } catch (Exception e) {
    ...
    /**
     * CDCQuery mapper for {@link #serialize(BatchItemRequest, JsonGenerator, SerializerProvider)}}
     *
     * @return ObjectMapper
     */
    private static ObjectMapper getCDCQueryMapper() {
