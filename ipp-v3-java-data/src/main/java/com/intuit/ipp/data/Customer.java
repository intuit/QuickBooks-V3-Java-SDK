    ...
    implements Serializable, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsClientCompanyId;
            lhsClientCompanyId = this.getClientCompanyId();
            String rhsClientCompanyId;
            rhsClientCompanyId = that.getClientCompanyId();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "clientCompanyId", lhsClientCompanyId), LocatorUtils.property(thatLocator, "clientCompanyId", rhsClientCompanyId), lhsClientCompanyId, rhsClientCompanyId, (this.clientCompanyId!= null), (that.clientCompanyId!= null))) {
                return false;
            }
        }
        {
            String lhsClientEntityId;
            lhsClientEntityId = this.getClientEntityId();
            String rhsClientEntityId;
            rhsClientEntityId = that.getClientEntityId();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "clientEntityId", lhsClientEntityId), LocatorUtils.property(thatLocator, "clientEntityId", rhsClientEntityId), lhsClientEntityId, rhsClientEntityId, (this.clientEntityId!= null), (that.clientEntityId!= null))) {
                return false;
            }
        }
        {
        ...
        {
            String lhsTaxRegime;
            lhsTaxRegime = this.getTaxRegime();
            String rhsTaxRegime;
            rhsTaxRegime = that.getTaxRegime();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "taxRegime", lhsTaxRegime), LocatorUtils.property(thatLocator, "taxRegime", rhsTaxRegime), lhsTaxRegime, rhsTaxRegime, (this.taxRegime!= null), (that.taxRegime!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            String theClientCompanyId;
            theClientCompanyId = this.getClientCompanyId();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "clientCompanyId", theClientCompanyId), currentHashCode, theClientCompanyId, (this.clientCompanyId!= null));
        }
        {
            String theClientEntityId;
            theClientEntityId = this.getClientEntityId();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "clientEntityId", theClientEntityId), currentHashCode, theClientEntityId, (this.clientEntityId!= null));
        }
        {
            String theSource;
        ...
        {
            String theTaxRegime;
            theTaxRegime = this.getTaxRegime();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "taxRegime", theTaxRegime), currentHashCode, theTaxRegime, (this.taxRegime!= null));
        }
