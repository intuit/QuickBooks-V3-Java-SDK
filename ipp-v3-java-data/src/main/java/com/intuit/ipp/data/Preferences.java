    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final Preferences that = ((Preferences) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "accountingInfoPrefs", lhsAccountingInfoPrefs), LocatorUtils.property(thatLocator, "accountingInfoPrefs", rhsAccountingInfoPrefs), lhsAccountingInfoPrefs, rhsAccountingInfoPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "advancedInventoryPrefs", lhsAdvancedInventoryPrefs), LocatorUtils.property(thatLocator, "advancedInventoryPrefs", rhsAdvancedInventoryPrefs), lhsAdvancedInventoryPrefs, rhsAdvancedInventoryPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "productAndServicesPrefs", lhsProductAndServicesPrefs), LocatorUtils.property(thatLocator, "productAndServicesPrefs", rhsProductAndServicesPrefs), lhsProductAndServicesPrefs, rhsProductAndServicesPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "salesFormsPrefs", lhsSalesFormsPrefs), LocatorUtils.property(thatLocator, "salesFormsPrefs", rhsSalesFormsPrefs), lhsSalesFormsPrefs, rhsSalesFormsPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "emailMessagesPrefs", lhsEmailMessagesPrefs), LocatorUtils.property(thatLocator, "emailMessagesPrefs", rhsEmailMessagesPrefs), lhsEmailMessagesPrefs, rhsEmailMessagesPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "printDocumentPrefs", lhsPrintDocumentPrefs), LocatorUtils.property(thatLocator, "printDocumentPrefs", rhsPrintDocumentPrefs), lhsPrintDocumentPrefs, rhsPrintDocumentPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "vendorAndPurchasesPrefs", lhsVendorAndPurchasesPrefs), LocatorUtils.property(thatLocator, "vendorAndPurchasesPrefs", rhsVendorAndPurchasesPrefs), lhsVendorAndPurchasesPrefs, rhsVendorAndPurchasesPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeTrackingPrefs", lhsTimeTrackingPrefs), LocatorUtils.property(thatLocator, "timeTrackingPrefs", rhsTimeTrackingPrefs), lhsTimeTrackingPrefs, rhsTimeTrackingPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "taxPrefs", lhsTaxPrefs), LocatorUtils.property(thatLocator, "taxPrefs", rhsTaxPrefs), lhsTaxPrefs, rhsTaxPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "financeChargesPrefs", lhsFinanceChargesPrefs), LocatorUtils.property(thatLocator, "financeChargesPrefs", rhsFinanceChargesPrefs), lhsFinanceChargesPrefs, rhsFinanceChargesPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "currencyPrefs", lhsCurrencyPrefs), LocatorUtils.property(thatLocator, "currencyPrefs", rhsCurrencyPrefs), lhsCurrencyPrefs, rhsCurrencyPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "reportPrefs", lhsReportPrefs), LocatorUtils.property(thatLocator, "reportPrefs", rhsReportPrefs), lhsReportPrefs, rhsReportPrefs)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "otherPrefs", lhsOtherPrefs), LocatorUtils.property(thatLocator, "otherPrefs", rhsOtherPrefs), lhsOtherPrefs, rhsOtherPrefs)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "accountingInfoPrefs", theAccountingInfoPrefs), currentHashCode, theAccountingInfoPrefs);
        }
        {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "productAndServicesPrefs", theProductAndServicesPrefs), currentHashCode, theProductAndServicesPrefs);
        }
        {
            SalesFormsPrefs theSalesFormsPrefs;
            theSalesFormsPrefs = this.getSalesFormsPrefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "salesFormsPrefs", theSalesFormsPrefs), currentHashCode, theSalesFormsPrefs);
        }
        {
            EmailMessagesPrefs theEmailMessagesPrefs;
            theEmailMessagesPrefs = this.getEmailMessagesPrefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "emailMessagesPrefs", theEmailMessagesPrefs), currentHashCode, theEmailMessagesPrefs);
        }
        {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "vendorAndPurchasesPrefs", theVendorAndPurchasesPrefs), currentHashCode, theVendorAndPurchasesPrefs);
        }
        {
            TimeTrackingPrefs theTimeTrackingPrefs;
            theTimeTrackingPrefs = this.getTimeTrackingPrefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeTrackingPrefs", theTimeTrackingPrefs), currentHashCode, theTimeTrackingPrefs);
        }
        {
            TaxPrefs theTaxPrefs;
            theTaxPrefs = this.getTaxPrefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "taxPrefs", theTaxPrefs), currentHashCode, theTaxPrefs);
        }
        {
            FinanceChargePrefs theFinanceChargesPrefs;
            theFinanceChargesPrefs = this.getFinanceChargesPrefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "financeChargesPrefs", theFinanceChargesPrefs), currentHashCode, theFinanceChargesPrefs);
        }
        {
            CurrencyPrefs theCurrencyPrefs;
            theCurrencyPrefs = this.getCurrencyPrefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "currencyPrefs", theCurrencyPrefs), currentHashCode, theCurrencyPrefs);
        }
        {
            ReportPrefs theReportPrefs;
            theReportPrefs = this.getReportPrefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "reportPrefs", theReportPrefs), currentHashCode, theReportPrefs);
        }
        {
            OtherPrefs theOtherPrefs;
            theOtherPrefs = this.getOtherPrefs();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "otherPrefs", theOtherPrefs), currentHashCode, theOtherPrefs);
        }
