 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="Thresholds" type="{http://www.w3.org/2001/XMLSchema}anyType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class EntitlementsResponse implements Serializable, Response, Equals2, HashCode2
{
    ...
    public List<Object> getThresholds() {
        if (thresholds == null) {
            thresholds = new ArrayList<Object>();
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<Object> lhsThresholds;
            lhsThresholds = (((this.thresholds!= null)&&(!this.thresholds.isEmpty()))?this.getThresholds():null);
            List<Object> rhsThresholds;
            rhsThresholds = (((that.thresholds!= null)&&(!that.thresholds.isEmpty()))?that.getThresholds():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "thresholds", lhsThresholds), LocatorUtils.property(thatLocator, "thresholds", rhsThresholds), lhsThresholds, rhsThresholds, ((this.thresholds!= null)&&(!this.thresholds.isEmpty())), ((that.thresholds!= null)&&(!that.thresholds.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            List<Object> theThresholds;
            theThresholds = (((this.thresholds!= null)&&(!this.thresholds.isEmpty()))?this.getThresholds():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "thresholds", theThresholds), currentHashCode, theThresholds, ((this.thresholds!= null)&&(!this.thresholds.isEmpty())));
        }
