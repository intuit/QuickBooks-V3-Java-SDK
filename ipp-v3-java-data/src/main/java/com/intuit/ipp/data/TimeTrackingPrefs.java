    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeTrackingPrefs)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final TimeTrackingPrefs that = ((TimeTrackingPrefs) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "useServices", lhsUseServices), LocatorUtils.property(thatLocator, "useServices", rhsUseServices), lhsUseServices, rhsUseServices)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "defaultTimeItem", lhsDefaultTimeItem), LocatorUtils.property(thatLocator, "defaultTimeItem", rhsDefaultTimeItem), lhsDefaultTimeItem, rhsDefaultTimeItem)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "billCustomers", lhsBillCustomers), LocatorUtils.property(thatLocator, "billCustomers", rhsBillCustomers), lhsBillCustomers, rhsBillCustomers)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "showBillRateToAll", lhsShowBillRateToAll), LocatorUtils.property(thatLocator, "showBillRateToAll", rhsShowBillRateToAll), lhsShowBillRateToAll, rhsShowBillRateToAll)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "workWeekStartDate", lhsWorkWeekStartDate), LocatorUtils.property(thatLocator, "workWeekStartDate", rhsWorkWeekStartDate), lhsWorkWeekStartDate, rhsWorkWeekStartDate)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeTrackingEnabled", lhsTimeTrackingEnabled), LocatorUtils.property(thatLocator, "timeTrackingEnabled", rhsTimeTrackingEnabled), lhsTimeTrackingEnabled, rhsTimeTrackingEnabled)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "markTimeEntriesBillable", lhsMarkTimeEntriesBillable), LocatorUtils.property(thatLocator, "markTimeEntriesBillable", rhsMarkTimeEntriesBillable), lhsMarkTimeEntriesBillable, rhsMarkTimeEntriesBillable)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "markExpensesAsBillable", lhsMarkExpensesAsBillable), LocatorUtils.property(thatLocator, "markExpensesAsBillable", rhsMarkExpensesAsBillable), lhsMarkExpensesAsBillable, rhsMarkExpensesAsBillable)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "useServices", theUseServices), currentHashCode, theUseServices);
        }
        {
            ReferenceType theDefaultTimeItem;
            theDefaultTimeItem = this.getDefaultTimeItem();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "defaultTimeItem", theDefaultTimeItem), currentHashCode, theDefaultTimeItem);
        }
        {
            Boolean theBillCustomers;
            theBillCustomers = this.isBillCustomers();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "billCustomers", theBillCustomers), currentHashCode, theBillCustomers);
        }
        {
            Boolean theShowBillRateToAll;
            theShowBillRateToAll = this.isShowBillRateToAll();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "showBillRateToAll", theShowBillRateToAll), currentHashCode, theShowBillRateToAll);
        }
        {
            WeekEnum theWorkWeekStartDate;
            theWorkWeekStartDate = this.getWorkWeekStartDate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "workWeekStartDate", theWorkWeekStartDate), currentHashCode, theWorkWeekStartDate);
        }
        {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "markTimeEntriesBillable", theMarkTimeEntriesBillable), currentHashCode, theMarkTimeEntriesBillable);
        }
        {
            Boolean theMarkExpensesAsBillable;
            theMarkExpensesAsBillable = this.isMarkExpensesAsBillable();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "markExpensesAsBillable", theMarkExpensesAsBillable), currentHashCode, theMarkExpensesAsBillable);
        }
