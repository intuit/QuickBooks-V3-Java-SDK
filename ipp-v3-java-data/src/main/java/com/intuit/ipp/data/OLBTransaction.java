    ...
    implements Serializable, IEntity, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OLBTransaction)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "olbTxn", lhsOLBTxn), LocatorUtils.property(thatLocator, "olbTxn", rhsOLBTxn), lhsOLBTxn, rhsOLBTxn)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "olbDownloadTime", theOLBDownloadTime), currentHashCode, theOLBDownloadTime);
        }
        {
            List<OLBTxn> theOLBTxn;
            theOLBTxn = (((this.olbTxn!= null)&&(!this.olbTxn.isEmpty()))?this.getOLBTxn():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "olbTxn", theOLBTxn), currentHashCode, theOLBTxn);
        }
