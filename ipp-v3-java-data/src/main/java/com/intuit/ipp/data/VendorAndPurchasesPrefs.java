    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof VendorAndPurchasesPrefs)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final VendorAndPurchasesPrefs that = ((VendorAndPurchasesPrefs) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "enableBills", lhsEnableBills), LocatorUtils.property(thatLocator, "enableBills", rhsEnableBills), lhsEnableBills, rhsEnableBills)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "trackingByCustomer", lhsTrackingByCustomer), LocatorUtils.property(thatLocator, "trackingByCustomer", rhsTrackingByCustomer), lhsTrackingByCustomer, rhsTrackingByCustomer)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "billableExpenseTracking", lhsBillableExpenseTracking), LocatorUtils.property(thatLocator, "billableExpenseTracking", rhsBillableExpenseTracking), lhsBillableExpenseTracking, rhsBillableExpenseTracking)) {
                return false;
            }
        }
        {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "defaultMarkupAccount", lhsDefaultMarkupAccount), LocatorUtils.property(thatLocator, "defaultMarkupAccount", rhsDefaultMarkupAccount), lhsDefaultMarkupAccount, rhsDefaultMarkupAccount)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "automaticBillPayment", lhsAutomaticBillPayment), LocatorUtils.property(thatLocator, "automaticBillPayment", rhsAutomaticBillPayment), lhsAutomaticBillPayment, rhsAutomaticBillPayment)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "poCustomField", lhsPOCustomField), LocatorUtils.property(thatLocator, "poCustomField", rhsPOCustomField), lhsPOCustomField, rhsPOCustomField)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "msgToVendors", lhsMsgToVendors), LocatorUtils.property(thatLocator, "msgToVendors", rhsMsgToVendors), lhsMsgToVendors, rhsMsgToVendors)) {
                return false;
            }
        }
        {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "usingMultiLocationInventory", lhsUsingMultiLocationInventory), LocatorUtils.property(thatLocator, "usingMultiLocationInventory", rhsUsingMultiLocationInventory), lhsUsingMultiLocationInventory, rhsUsingMultiLocationInventory)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "enableBills", theEnableBills), currentHashCode, theEnableBills);
        }
        {
            Boolean theTrackingByCustomer;
            theTrackingByCustomer = this.isTrackingByCustomer();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "trackingByCustomer", theTrackingByCustomer), currentHashCode, theTrackingByCustomer);
        }
        {
            Boolean theBillableExpenseTracking;
            theBillableExpenseTracking = this.isBillableExpenseTracking();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "billableExpenseTracking", theBillableExpenseTracking), currentHashCode, theBillableExpenseTracking);
        }
        {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "defaultMarkupAccount", theDefaultMarkupAccount), currentHashCode, theDefaultMarkupAccount);
        }
        {
            Boolean theAutomaticBillPayment;
            theAutomaticBillPayment = this.isAutomaticBillPayment();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "automaticBillPayment", theAutomaticBillPayment), currentHashCode, theAutomaticBillPayment);
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "poCustomField", thePOCustomField), currentHashCode, thePOCustomField);
        }
        {
            String theMsgToVendors;
            theMsgToVendors = this.getMsgToVendors();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "msgToVendors", theMsgToVendors), currentHashCode, theMsgToVendors);
        }
        {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "usingMultiLocationInventory", theUsingMultiLocationInventory), currentHashCode, theUsingMultiLocationInventory);
        }
        {
