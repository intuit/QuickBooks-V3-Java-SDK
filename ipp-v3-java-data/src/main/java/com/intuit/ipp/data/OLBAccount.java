    ...
    implements Serializable, IEntity, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OLBAccount)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "accountDetails", lhsAccountDetails), LocatorUtils.property(thatLocator, "accountDetails", rhsAccountDetails), lhsAccountDetails, rhsAccountDetails)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "subscribedToApp", lhsSubscribedToApp), LocatorUtils.property(thatLocator, "subscribedToApp", rhsSubscribedToApp), lhsSubscribedToApp, rhsSubscribedToApp)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "appVersion", lhsAppVersion), LocatorUtils.property(thatLocator, "appVersion", rhsAppVersion), lhsAppVersion, rhsAppVersion)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "lastBankBalance", lhsLastBankBalance), LocatorUtils.property(thatLocator, "lastBankBalance", rhsLastBankBalance), lhsLastBankBalance, rhsLastBankBalance)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "accountDetails", theAccountDetails), currentHashCode, theAccountDetails);
        }
        {
            Boolean theSubscribedToApp;
            theSubscribedToApp = this.isSubscribedToApp();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "subscribedToApp", theSubscribedToApp), currentHashCode, theSubscribedToApp);
        }
        {
            String theAppVersion;
            theAppVersion = this.getAppVersion();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "appVersion", theAppVersion), currentHashCode, theAppVersion);
        }
        {
            BigDecimal theLastBankBalance;
            theLastBankBalance = this.getLastBankBalance();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "lastBankBalance", theLastBankBalance), currentHashCode, theLastBankBalance);
        }
