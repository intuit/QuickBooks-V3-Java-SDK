 ...
 *         &lt;element name="AllowOnlineAffirmPayment" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 ...
 *         &lt;element name="EnabledSurchargeInfo" type="{http://schema.intuit.com/finance/v3}EnabledSurchargeInfo" minOccurs="0"/&gt;
 ...
 *         &lt;element name="TxnRetainageDetail" type="{http://schema.intuit.com/finance/v3}TxnRetainageDetail" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable, Equals2, HashCode2
{
    ...
    @XmlElement(name = "AllowOnlineAffirmPayment")
    protected Boolean allowOnlineAffirmPayment;
    ...
    @XmlElement(name = "EnabledSurchargeInfo")
    protected EnabledSurchargeInfo enabledSurchargeInfo;
    ...
    @XmlElement(name = "TxnRetainageDetail")
    protected TxnRetainageDetail txnRetainageDetail;
    ...
    /**
     * Gets the value of the allowOnlineAffirmPayment property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isAllowOnlineAffirmPayment() {
        return allowOnlineAffirmPayment;
    }

    /**
     * Sets the value of the allowOnlineAffirmPayment property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setAllowOnlineAffirmPayment(Boolean value) {
        this.allowOnlineAffirmPayment = value;
    }
    ...
    /**
     * Gets the value of the enabledSurchargeInfo property.
     * 
     * @return
     *     possible object is
     *     {@link EnabledSurchargeInfo }
     *     
     */
    public EnabledSurchargeInfo getEnabledSurchargeInfo() {
        return enabledSurchargeInfo;
    }

    /**
     * Sets the value of the enabledSurchargeInfo property.
     * 
     * @param value
     *     allowed object is
     *     {@link EnabledSurchargeInfo }
     *     
     */
    public void setEnabledSurchargeInfo(EnabledSurchargeInfo value) {
        this.enabledSurchargeInfo = value;
    }
    ...
    /**
     * Gets the value of the txnRetainageDetail property.
     * 
     * @return
     *     possible object is
     *     {@link TxnRetainageDetail }
     *     
     */
    public TxnRetainageDetail getTxnRetainageDetail() {
        return txnRetainageDetail;
    }

    /**
     * Sets the value of the txnRetainageDetail property.
     * 
     * @param value
     *     allowed object is
     *     {@link TxnRetainageDetail }
     *     
     */
    public void setTxnRetainageDetail(TxnRetainageDetail value) {
        this.txnRetainageDetail = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            Boolean lhsAllowOnlinePayPalPayment;
            lhsAllowOnlinePayPalPayment = this.isAllowOnlinePayPalPayment();
            Boolean rhsAllowOnlinePayPalPayment;
            rhsAllowOnlinePayPalPayment = that.isAllowOnlinePayPalPayment();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "allowOnlinePayPalPayment", lhsAllowOnlinePayPalPayment), LocatorUtils.property(thatLocator, "allowOnlinePayPalPayment", rhsAllowOnlinePayPalPayment), lhsAllowOnlinePayPalPayment, rhsAllowOnlinePayPalPayment, (this.allowOnlinePayPalPayment!= null), (that.allowOnlinePayPalPayment!= null))) {
                return false;
            }
        }
        {
            Boolean lhsAllowOnlineAffirmPayment;
            lhsAllowOnlineAffirmPayment = this.isAllowOnlineAffirmPayment();
            Boolean rhsAllowOnlineAffirmPayment;
            rhsAllowOnlineAffirmPayment = that.isAllowOnlineAffirmPayment();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "allowOnlineAffirmPayment", lhsAllowOnlineAffirmPayment), LocatorUtils.property(thatLocator, "allowOnlineAffirmPayment", rhsAllowOnlineAffirmPayment), lhsAllowOnlineAffirmPayment, rhsAllowOnlineAffirmPayment, (this.allowOnlineAffirmPayment!= null), (that.allowOnlineAffirmPayment!= null))) {
                return false;
            }
        }
        {
        ...
        {
            Integer lhsCfdiUse;
            lhsCfdiUse = this.getCfdiUse();
            Integer rhsCfdiUse;
            rhsCfdiUse = that.getCfdiUse();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "cfdiUse", lhsCfdiUse), LocatorUtils.property(thatLocator, "cfdiUse", rhsCfdiUse), lhsCfdiUse, rhsCfdiUse, (this.cfdiUse!= null), (that.cfdiUse!= null))) {
                return false;
            }
        }
        {
            String lhsExportation;
            lhsExportation = this.getExportation();
            String rhsExportation;
            rhsExportation = that.getExportation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "exportation", lhsExportation), LocatorUtils.property(thatLocator, "exportation", rhsExportation), lhsExportation, rhsExportation, (this.exportation!= null), (that.exportation!= null))) {
                return false;
            }
        }
        {
            MXGlobalInfo lhsGlobalInfo;
            lhsGlobalInfo = this.getGlobalInfo();
            MXGlobalInfo rhsGlobalInfo;
            rhsGlobalInfo = that.getGlobalInfo();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "globalInfo", lhsGlobalInfo), LocatorUtils.property(thatLocator, "globalInfo", rhsGlobalInfo), lhsGlobalInfo, rhsGlobalInfo, (this.globalInfo!= null), (that.globalInfo!= null))) {
                return false;
            }
        }
        {
        ...
        {
            EnabledSurchargeInfo lhsEnabledSurchargeInfo;
            lhsEnabledSurchargeInfo = this.getEnabledSurchargeInfo();
            EnabledSurchargeInfo rhsEnabledSurchargeInfo;
            rhsEnabledSurchargeInfo = that.getEnabledSurchargeInfo();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "enabledSurchargeInfo", lhsEnabledSurchargeInfo), LocatorUtils.property(thatLocator, "enabledSurchargeInfo", rhsEnabledSurchargeInfo), lhsEnabledSurchargeInfo, rhsEnabledSurchargeInfo, (this.enabledSurchargeInfo!= null), (that.enabledSurchargeInfo!= null))) {
                return false;
            }
        }
        {
        ...
        {
            String lhsScheduledPaymentId;
            lhsScheduledPaymentId = this.getScheduledPaymentId();
            String rhsScheduledPaymentId;
            rhsScheduledPaymentId = that.getScheduledPaymentId();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "scheduledPaymentId", lhsScheduledPaymentId), LocatorUtils.property(thatLocator, "scheduledPaymentId", rhsScheduledPaymentId), lhsScheduledPaymentId, rhsScheduledPaymentId, (this.scheduledPaymentId!= null), (that.scheduledPaymentId!= null))) {
                return false;
            }
        }
        {
            Boolean lhsGratuityEnabled;
            lhsGratuityEnabled = this.isGratuityEnabled();
            Boolean rhsGratuityEnabled;
            rhsGratuityEnabled = that.isGratuityEnabled();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "gratuityEnabled", lhsGratuityEnabled), LocatorUtils.property(thatLocator, "gratuityEnabled", rhsGratuityEnabled), lhsGratuityEnabled, rhsGratuityEnabled, (this.gratuityEnabled!= null), (that.gratuityEnabled!= null))) {
                return false;
            }
        }
        {
            FinancingProductTypeEnum lhsFinancingProductType;
            lhsFinancingProductType = this.getFinancingProductType();
            FinancingProductTypeEnum rhsFinancingProductType;
            rhsFinancingProductType = that.getFinancingProductType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "financingProductType", lhsFinancingProductType), LocatorUtils.property(thatLocator, "financingProductType", rhsFinancingProductType), lhsFinancingProductType, rhsFinancingProductType, (this.financingProductType!= null), (that.financingProductType!= null))) {
                return false;
            }
        }
        {
            SubscriptionPaymentsSettingEnum lhsSubscriptionPaymentsSetting;
            lhsSubscriptionPaymentsSetting = this.getSubscriptionPaymentsSetting();
            SubscriptionPaymentsSettingEnum rhsSubscriptionPaymentsSetting;
            rhsSubscriptionPaymentsSetting = that.getSubscriptionPaymentsSetting();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "subscriptionPaymentsSetting", lhsSubscriptionPaymentsSetting), LocatorUtils.property(thatLocator, "subscriptionPaymentsSetting", rhsSubscriptionPaymentsSetting), lhsSubscriptionPaymentsSetting, rhsSubscriptionPaymentsSetting, (this.subscriptionPaymentsSetting!= null), (that.subscriptionPaymentsSetting!= null))) {
                return false;
            }
        }
        {
            TxnRetainageDetail lhsTxnRetainageDetail;
            lhsTxnRetainageDetail = this.getTxnRetainageDetail();
            TxnRetainageDetail rhsTxnRetainageDetail;
            rhsTxnRetainageDetail = that.getTxnRetainageDetail();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "txnRetainageDetail", lhsTxnRetainageDetail), LocatorUtils.property(thatLocator, "txnRetainageDetail", rhsTxnRetainageDetail), lhsTxnRetainageDetail, rhsTxnRetainageDetail, (this.txnRetainageDetail!= null), (that.txnRetainageDetail!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            Boolean theAllowOnlinePayPalPayment;
            theAllowOnlinePayPalPayment = this.isAllowOnlinePayPalPayment();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "allowOnlinePayPalPayment", theAllowOnlinePayPalPayment), currentHashCode, theAllowOnlinePayPalPayment, (this.allowOnlinePayPalPayment!= null));
        }
        {
            Boolean theAllowOnlineAffirmPayment;
            theAllowOnlineAffirmPayment = this.isAllowOnlineAffirmPayment();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "allowOnlineAffirmPayment", theAllowOnlineAffirmPayment), currentHashCode, theAllowOnlineAffirmPayment, (this.allowOnlineAffirmPayment!= null));
        }
        {
        ...
        {
            Integer theCfdiUse;
            theCfdiUse = this.getCfdiUse();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "cfdiUse", theCfdiUse), currentHashCode, theCfdiUse, (this.cfdiUse!= null));
        }
        {
            String theExportation;
            theExportation = this.getExportation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "exportation", theExportation), currentHashCode, theExportation, (this.exportation!= null));
        }
        {
            MXGlobalInfo theGlobalInfo;
            theGlobalInfo = this.getGlobalInfo();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "globalInfo", theGlobalInfo), currentHashCode, theGlobalInfo, (this.globalInfo!= null));
        }
        {
        ...
        {
            EnabledSurchargeInfo theEnabledSurchargeInfo;
            theEnabledSurchargeInfo = this.getEnabledSurchargeInfo();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "enabledSurchargeInfo", theEnabledSurchargeInfo), currentHashCode, theEnabledSurchargeInfo, (this.enabledSurchargeInfo!= null));
        }
        {
        ...
        {
            String theScheduledPaymentId;
            theScheduledPaymentId = this.getScheduledPaymentId();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "scheduledPaymentId", theScheduledPaymentId), currentHashCode, theScheduledPaymentId, (this.scheduledPaymentId!= null));
        }
        {
            Boolean theGratuityEnabled;
            theGratuityEnabled = this.isGratuityEnabled();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "gratuityEnabled", theGratuityEnabled), currentHashCode, theGratuityEnabled, (this.gratuityEnabled!= null));
        }
        {
            FinancingProductTypeEnum theFinancingProductType;
            theFinancingProductType = this.getFinancingProductType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "financingProductType", theFinancingProductType), currentHashCode, theFinancingProductType, (this.financingProductType!= null));
        }
        {
            SubscriptionPaymentsSettingEnum theSubscriptionPaymentsSetting;
            theSubscriptionPaymentsSetting = this.getSubscriptionPaymentsSetting();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "subscriptionPaymentsSetting", theSubscriptionPaymentsSetting), currentHashCode, theSubscriptionPaymentsSetting, (this.subscriptionPaymentsSetting!= null));
        }
        {
            TxnRetainageDetail theTxnRetainageDetail;
            theTxnRetainageDetail = this.getTxnRetainageDetail();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "txnRetainageDetail", theTxnRetainageDetail), currentHashCode, theTxnRetainageDetail, (this.txnRetainageDetail!= null));
        }
