 ...
 *         &lt;element name="AgencyVerificationStatus" type="{http://schema.intuit.com/finance/v3}AgencyVerificationStatus" minOccurs="0"/&gt;
 *         &lt;element name="AgencyVerificationStatusMsg" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="AgencyVerificationTSUTC" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/&gt;
    ...
    implements Serializable, Equals2, HashCode2
{
    ...
    @XmlElement(name = "AgencyVerificationStatus")
    @XmlSchemaType(name = "string")
    protected AgencyVerificationStatus agencyVerificationStatus;
    @XmlElement(name = "AgencyVerificationStatusMsg")
    protected String agencyVerificationStatusMsg;
    @XmlElement(name = "AgencyVerificationTSUTC", type = String.class)
    @XmlJavaTypeAdapter(DateTimeAdapter.class)
    @XmlSchemaType(name = "dateTime")
    protected Date agencyVerificationTSUTC;
    ...
    /**
     * Gets the value of the agencyVerificationStatus property.
     * 
     * @return
     *     possible object is
     *     {@link AgencyVerificationStatus }
     *     
     */
    public AgencyVerificationStatus getAgencyVerificationStatus() {
        return agencyVerificationStatus;
    }

    /**
     * Sets the value of the agencyVerificationStatus property.
     * 
     * @param value
     *     allowed object is
     *     {@link AgencyVerificationStatus }
     *     
     */
    public void setAgencyVerificationStatus(AgencyVerificationStatus value) {
        this.agencyVerificationStatus = value;
    }

    /**
     * Gets the value of the agencyVerificationStatusMsg property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAgencyVerificationStatusMsg() {
        return agencyVerificationStatusMsg;
    }

    /**
     * Sets the value of the agencyVerificationStatusMsg property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAgencyVerificationStatusMsg(String value) {
        this.agencyVerificationStatusMsg = value;
    }

    /**
     * Gets the value of the agencyVerificationTSUTC property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public Date getAgencyVerificationTSUTC() {
        return agencyVerificationTSUTC;
    }

    /**
     * Sets the value of the agencyVerificationTSUTC property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAgencyVerificationTSUTC(Date value) {
        this.agencyVerificationTSUTC = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            AgencyVerificationStatus lhsAgencyVerificationStatus;
            lhsAgencyVerificationStatus = this.getAgencyVerificationStatus();
            AgencyVerificationStatus rhsAgencyVerificationStatus;
            rhsAgencyVerificationStatus = that.getAgencyVerificationStatus();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "agencyVerificationStatus", lhsAgencyVerificationStatus), LocatorUtils.property(thatLocator, "agencyVerificationStatus", rhsAgencyVerificationStatus), lhsAgencyVerificationStatus, rhsAgencyVerificationStatus, (this.agencyVerificationStatus!= null), (that.agencyVerificationStatus!= null))) {
                return false;
            }
        }
        {
            String lhsAgencyVerificationStatusMsg;
            lhsAgencyVerificationStatusMsg = this.getAgencyVerificationStatusMsg();
            String rhsAgencyVerificationStatusMsg;
            rhsAgencyVerificationStatusMsg = that.getAgencyVerificationStatusMsg();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "agencyVerificationStatusMsg", lhsAgencyVerificationStatusMsg), LocatorUtils.property(thatLocator, "agencyVerificationStatusMsg", rhsAgencyVerificationStatusMsg), lhsAgencyVerificationStatusMsg, rhsAgencyVerificationStatusMsg, (this.agencyVerificationStatusMsg!= null), (that.agencyVerificationStatusMsg!= null))) {
                return false;
            }
        }
        {
            Date lhsAgencyVerificationTSUTC;
            lhsAgencyVerificationTSUTC = this.getAgencyVerificationTSUTC();
            Date rhsAgencyVerificationTSUTC;
            rhsAgencyVerificationTSUTC = that.getAgencyVerificationTSUTC();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "agencyVerificationTSUTC", lhsAgencyVerificationTSUTC), LocatorUtils.property(thatLocator, "agencyVerificationTSUTC", rhsAgencyVerificationTSUTC), lhsAgencyVerificationTSUTC, rhsAgencyVerificationTSUTC, (this.agencyVerificationTSUTC!= null), (that.agencyVerificationTSUTC!= null))) {
                return false;
            }
        }
        {
            String lhsCompanyRegistrationNumber;
            lhsCompanyRegistrationNumber = this.getCompanyRegistrationNumber();
            String rhsCompanyRegistrationNumber;
            rhsCompanyRegistrationNumber = that.getCompanyRegistrationNumber();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "companyRegistrationNumber", lhsCompanyRegistrationNumber), LocatorUtils.property(thatLocator, "companyRegistrationNumber", rhsCompanyRegistrationNumber), lhsCompanyRegistrationNumber, rhsCompanyRegistrationNumber, (this.companyRegistrationNumber!= null), (that.companyRegistrationNumber!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            AgencyVerificationStatus theAgencyVerificationStatus;
            theAgencyVerificationStatus = this.getAgencyVerificationStatus();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "agencyVerificationStatus", theAgencyVerificationStatus), currentHashCode, theAgencyVerificationStatus, (this.agencyVerificationStatus!= null));
        }
        {
            String theAgencyVerificationStatusMsg;
            theAgencyVerificationStatusMsg = this.getAgencyVerificationStatusMsg();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "agencyVerificationStatusMsg", theAgencyVerificationStatusMsg), currentHashCode, theAgencyVerificationStatusMsg, (this.agencyVerificationStatusMsg!= null));
        }
        {
            Date theAgencyVerificationTSUTC;
            theAgencyVerificationTSUTC = this.getAgencyVerificationTSUTC();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "agencyVerificationTSUTC", theAgencyVerificationTSUTC), currentHashCode, theAgencyVerificationTSUTC, (this.agencyVerificationTSUTC!= null));
        }
        {
            String theCompanyRegistrationNumber;
            theCompanyRegistrationNumber = this.getCompanyRegistrationNumber();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "companyRegistrationNumber", theCompanyRegistrationNumber), currentHashCode, theCompanyRegistrationNumber, (this.companyRegistrationNumber!= null));
        }
