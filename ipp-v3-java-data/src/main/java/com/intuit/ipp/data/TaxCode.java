    ...
    implements Serializable, Equals2, HashCode2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            GTMConfigTypeEnum lhsTaxCodeConfigType;
            lhsTaxCodeConfigType = this.getTaxCodeConfigType();
            GTMConfigTypeEnum rhsTaxCodeConfigType;
            rhsTaxCodeConfigType = that.getTaxCodeConfigType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "taxCodeConfigType", lhsTaxCodeConfigType), LocatorUtils.property(thatLocator, "taxCodeConfigType", rhsTaxCodeConfigType), lhsTaxCodeConfigType, rhsTaxCodeConfigType, (this.taxCodeConfigType!= null), (that.taxCodeConfigType!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        {
            GTMConfigTypeEnum theTaxCodeConfigType;
            theTaxCodeConfigType = this.getTaxCodeConfigType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "taxCodeConfigType", theTaxCodeConfigType), currentHashCode, theTaxCodeConfigType, (this.taxCodeConfigType!= null));
        }
