    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "taxGroup", lhsTaxGroup), LocatorUtils.property(thatLocator, "taxGroup", rhsTaxGroup), lhsTaxGroup, rhsTaxGroup)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "salesTaxRateList", lhsSalesTaxRateList), LocatorUtils.property(thatLocator, "salesTaxRateList", rhsSalesTaxRateList), lhsSalesTaxRateList, rhsSalesTaxRateList)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "purchaseTaxRateList", lhsPurchaseTaxRateList), LocatorUtils.property(thatLocator, "purchaseTaxRateList", rhsPurchaseTaxRateList), lhsPurchaseTaxRateList, rhsPurchaseTaxRateList)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "adjustmentTaxRateList", lhsAdjustmentTaxRateList), LocatorUtils.property(thatLocator, "adjustmentTaxRateList", rhsAdjustmentTaxRateList), lhsAdjustmentTaxRateList, rhsAdjustmentTaxRateList)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "taxCodeEx", lhsTaxCodeEx), LocatorUtils.property(thatLocator, "taxCodeEx", rhsTaxCodeEx), lhsTaxCodeEx, rhsTaxCodeEx)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "taxGroup", theTaxGroup), currentHashCode, theTaxGroup);
        }
        {
            TaxRateList theSalesTaxRateList;
            theSalesTaxRateList = this.getSalesTaxRateList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "salesTaxRateList", theSalesTaxRateList), currentHashCode, theSalesTaxRateList);
        }
        {
            TaxRateList thePurchaseTaxRateList;
            thePurchaseTaxRateList = this.getPurchaseTaxRateList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "purchaseTaxRateList", thePurchaseTaxRateList), currentHashCode, thePurchaseTaxRateList);
        }
        {
            TaxRateList theAdjustmentTaxRateList;
            theAdjustmentTaxRateList = this.getAdjustmentTaxRateList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "adjustmentTaxRateList", theAdjustmentTaxRateList), currentHashCode, theAdjustmentTaxRateList);
        }
        {
            IntuitAnyType theTaxCodeEx;
            theTaxCodeEx = this.getTaxCodeEx();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "taxCodeEx", theTaxCodeEx), currentHashCode, theTaxCodeEx);
        }
