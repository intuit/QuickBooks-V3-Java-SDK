    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PriceLevelPerItem)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "customPrice", lhsCustomPrice), LocatorUtils.property(thatLocator, "customPrice", rhsCustomPrice), lhsCustomPrice, rhsCustomPrice)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "customPricePercent", lhsCustomPricePercent), LocatorUtils.property(thatLocator, "customPricePercent", rhsCustomPricePercent), lhsCustomPricePercent, rhsCustomPricePercent)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "priceLevelPerItemEx", lhsPriceLevelPerItemEx), LocatorUtils.property(thatLocator, "priceLevelPerItemEx", rhsPriceLevelPerItemEx), lhsPriceLevelPerItemEx, rhsPriceLevelPerItemEx)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "customPrice", theCustomPrice), currentHashCode, theCustomPrice);
        }
        {
            BigDecimal theCustomPricePercent;
            theCustomPricePercent = this.getCustomPricePercent();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "customPricePercent", theCustomPricePercent), currentHashCode, theCustomPricePercent);
        }
        {
            IntuitAnyType thePriceLevelPerItemEx;
            thePriceLevelPerItemEx = this.getPriceLevelPerItemEx();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "priceLevelPerItemEx", thePriceLevelPerItemEx), currentHashCode, thePriceLevelPerItemEx);
        }
