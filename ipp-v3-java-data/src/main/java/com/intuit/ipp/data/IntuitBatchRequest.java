    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IntuitBatchRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final IntuitBatchRequest that = ((IntuitBatchRequest) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "batchItemRequest", lhsBatchItemRequest), LocatorUtils.property(thatLocator, "batchItemRequest", rhsBatchItemRequest), lhsBatchItemRequest, rhsBatchItemRequest)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "batchItemRequest", theBatchItemRequest), currentHashCode, theBatchItemRequest);
        }
