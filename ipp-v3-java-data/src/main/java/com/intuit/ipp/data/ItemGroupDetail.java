    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ItemGroupDetail)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ItemGroupDetail that = ((ItemGroupDetail) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "itemGroupLine", lhsItemGroupLine), LocatorUtils.property(thatLocator, "itemGroupLine", rhsItemGroupLine), lhsItemGroupLine, rhsItemGroupLine)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "itemGroupLine", theItemGroupLine), currentHashCode, theItemGroupLine);
        }
