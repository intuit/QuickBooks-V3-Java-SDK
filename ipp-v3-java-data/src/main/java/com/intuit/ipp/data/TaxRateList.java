    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TaxRateList)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final TaxRateList that = ((TaxRateList) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "taxRateDetail", lhsTaxRateDetail), LocatorUtils.property(thatLocator, "taxRateDetail", rhsTaxRateDetail), lhsTaxRateDetail, rhsTaxRateDetail)) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "originatingGroupId", lhsOriginatingGroupId), LocatorUtils.property(thatLocator, "originatingGroupId", rhsOriginatingGroupId), lhsOriginatingGroupId, rhsOriginatingGroupId)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ...
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "taxRateDetail", theTaxRateDetail), currentHashCode, theTaxRateDetail);
        }
        {
            String theOriginatingGroupId;
            theOriginatingGroupId = this.getOriginatingGroupId();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "originatingGroupId", theOriginatingGroupId), currentHashCode, theOriginatingGroupId);
        }
